...
# LLM API（至少一个）：
#   DEEPSEEK_API_KEY（优先使用）、OPENROUTER_API_KEY（fallback）
#
# 公开 ID（已硬编码默认值，可 env 覆盖）：
#   NOTION_VERSION、NOTION_TASK_DB_ID、NOTION_TASK_DS_ID、NOTION_VERSION_DS_ID、OPENROUTER_MODEL、DEEPSEEK_MODEL
